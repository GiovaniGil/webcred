...
<div class="user-form">
    ...
    <div class="row">
        <div class="col-sm-4">
            <?= $form->field($model, 'name', ['template' =>
                ...
                </div>'])->textInput(['maxlength' => true, 'disabled' => 'true']) ?>
        </div>
        <div class="col-sm-2">
    ...
    <div class="row">
        <div class="col-sm-4">
            <?= $form->field($model, 'username', ['template' => "{label}<div class='controls'>{input}</div>{hint}{error}"])->textInput(['autofocus' => true, 'disabled' => 'true']) ?>
        </div>
        <div class="col-sm-4">
